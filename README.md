...
```bash
cd; curl -#L https://github.com/svassr/dotfiles/tarball/master | tar -xzv --strip-components 1 --exclude={README.md,bootstrap.sh,.osx,LICENSE-MIT.txt}
```
...
GIT_AUTHOR_NAME="Stephane Vasseur"
...
[welcome](https://github.com/svassr/dotfiles/issues)!
